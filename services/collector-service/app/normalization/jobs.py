...
def normalize_indeed_job(data: dict) -> CollectedJob:
    return CollectedJob(
        external_id=data["jobkey"],
        company_name=data["company"],
        company_url=data.get("company_url"),
        title=data["title"],
        location=data.get("location"),
        employment_type=data.get("job_type"),
...
def normalize_glassdoor_job(data: dict) -> CollectedJob:
    return CollectedJob(
